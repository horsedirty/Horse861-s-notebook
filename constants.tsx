    ...
    keyPoints: [
      {
        ...
        sections: [
          ...
          },
          {
            ...
            text: "Standard DH (Paul): $A_i$ 描述 $i-1 \\rightarrow i$。\nModified DH (Craig): 连杆坐标系建在连杆前端。参数定义略有不同，适用于树状结构机器人。"
          }
        ]
      },
      {
        ...
        sections: [
          {
            ...
            text: "通过相邻帧匹配（特征点法/直接法）计算相对运动。存在漂移 (Drift)。",
